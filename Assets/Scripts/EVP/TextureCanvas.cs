...
namespace EVP
{
	public class TextureCanvas
	{
		...
		private bool CheckForPixel()
		{
			...
			{
				int dashInterval = this.dashInterval;
				return m_step++ % (dashInterval * 2) < dashInterval;
			}
			return true;
		}
		...
		private void TexEllipse(int cx, int cy, int rx, int ry)
		{
			...
			int num6 = ry;
			int num7 = -ry;
			int num8 = (int)Mathf.Ceil((float)ry / Mathf.Sqrt(2f));
			float num9 = (float)rx / (float)ry;
			for (int j = 0; j <= num8; j++)
			{
				TexPixel((int)((float)cx + (float)j * num9), cy + num6);
				TexPixel((int)((float)cx + (float)j * num9), cy - num6);
				TexPixel((int)((float)cx - (float)j * num9), cy + num6);
				TexPixel((int)((float)cx - (float)j * num9), cy - num6);
				TexPixel((int)((float)cx + (float)num6 * num9), cy + j);
				TexPixel((int)((float)cx - (float)num6 * num9), cy + j);
				TexPixel((int)((float)cx + (float)num6 * num9), cy - j);
				TexPixel((int)((float)cx - (float)num6 * num9), cy - j);
				num7 += 2 * j + 1;
		...
		private void TexFillEllipse(int cx, int cy, int rx, int ry)
		{
			...
			for (int j = 0; j <= num8; j++)
			{
				TexSegmentH((int)((float)cx + (float)j * num9), cx, cy + num6);
				TexSegmentH((int)((float)cx + (float)j * num9), cx, cy - num6);
				TexSegmentH((int)((float)cx - (float)j * num9), cx, cy + num6);
				TexSegmentH((int)((float)cx - (float)j * num9), cx, cy - num6);
				TexSegmentH((int)((float)cx + (float)num6 * num9), cx, cy + j);
				TexSegmentH((int)((float)cx - (float)num6 * num9), cx, cy + j);
				TexSegmentH((int)((float)cx + (float)num6 * num9), cx, cy - j);
				TexSegmentH((int)((float)cx - (float)num6 * num9), cx, cy - j);
				num7 += 2 * j + 1;
