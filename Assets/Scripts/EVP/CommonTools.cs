	...
	public static class CommonTools
	{
		...
		public static Color ParseColor(string col)
		{
			...
			if (length > 0 && col[0] == "#"[0])
			{
				...
				case 5:
				{
					float num = 71f / (339f * (float)Math.PI);
		...
		{
			length *= 0.5f;
			Vector3 b = trans.forward * length;
			Vector3 b2 = trans.up * length;
			Vector3 b3 = trans.right * length;
			UnityEngine.Debug.DrawLine(pos - b, pos + b, col);
			UnityEngine.Debug.DrawLine(pos - b2, pos + b2, col);
			UnityEngine.Debug.DrawLine(pos - b3, pos + b3, col);
		}
