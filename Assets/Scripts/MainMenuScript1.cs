...
public class MainMenuScript1 : MonoBehaviour
{
	...
	public GameObject proModeActivate;

	public GameObject freeRoamActivate;
	...
	public void playScreenOptions(int option)
	{
		...
		case 0:
			...
			break;
		case 1:
			if (PlayerPrefs.GetInt("LevelsClearedAmature") >= 5)
			{
				freeRoamActivate.SetActive(value: false);
			}
			if (PlayerPrefs.GetInt("LevelsClearedAmature") >= 7)
			{
				proModeActivate.SetActive(value: false);
			}
		...
		case 2:
			...
			break;
		case 3:
			Application.OpenURL("https://play.google.com/store/apps/developer?id=FlipWired+3D+Games&hl");
			break;
		case 4:
			Application.OpenURL("https://www.facebook.com/sharer/sharer.php?u=https%3A//play.google.com/store/apps/developer?id=FlipWired%2B3D%2BGames");
			break;
		case 5:
			Application.OpenURL("https://web.facebook.com/sparkgamestudios");
			break;
		case 6:
		...
		case 7:
			...
			break;
		case 8:
			Application.OpenURL("market://details?id=com.fwd.freeworld.motorbike.stunt.racing");
			UnityEngine.Debug.Log("market://details?id=com.fwd.freeworld.motorbike.stunt.racing");
			break;
		default:
	...
	public void AdsTesting(int option)
	{
	}
	...
	private void Start()
	{
		...
		callUnityAd = false;
		PlayerPrefs.SetInt("adss_menu", 0);
		if (!PlayerPrefs.HasKey("SecondTime"))
		{
			...
			if (!PlayerPrefs.HasKey("LevelsClearedAmature"))
			{
				...
				PlayerPrefs.SetInt("LevelsClearedPro", 2);
			}
			soundStatus = 0;
			musicStatus = 0;
			if (!PlayerPrefs.HasKey("Cash"))
			{
				PlayerPrefs.SetInt("Cash", 10000);
			}
		}
		else
		{
	...
	private void Awake()
	{
		...
		LevelSelectCash.SetActive(value: false);
	}
	...
	private void Update()
	{
		...
		if (PlayerPrefs.GetInt("CarsUnlocked") == 1)
		{
			UnlockCars.SetActive(value: false);
		}
	...
	public void RateUs()
	{
		Application.OpenURL("https://play.google.com/store/apps/details?id=com.fwd.freeworld.motorbike.stunt.racing");
	}
